...
public class Chessboard {
    ...
    public String printBoard() {
        ...
        if (this.whiteKingSideCastle) str.append("White king side castle still legal\n");
        if (this.whiteQueenSideCastle) str.append("White queen side castle still legal\n");
        if (this.blackKingSideCastle) str.append("Black king side castle still legal\n");
        if (this.blackQueenSideCastle) str.append("Black queen side castle still legal\n");
